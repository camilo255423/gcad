...
class Facultad extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('centroCostoFacultad, nombre', 'required'),
			array('centroCostoFacultad', 'numerical', 'integerOnly'=>true),
			array('nombre', 'length', 'max'=>250),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('centroCostoFacultad, nombre', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'departamentos' => array(self::HAS_MANY, 'Departamento', 'centroCostoFacultad'),
		);
	}
