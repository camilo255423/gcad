...
class Vinculacion extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('codigoVinculacion, nombre', 'required'),
			array('codigoVinculacion', 'numerical', 'integerOnly'=>true),
			array('nombre', 'length', 'max'=>200),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('codigoVinculacion, nombre', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'profesors' => array(self::HAS_MANY, 'Profesor', 'codigoVinculacion'),
		);
	}
